...
var Peer = module.exports = function (options) {
    const magicStr = options.testnet ? options.coin.peerMagicTestnet : options.coin.peerMagic
    var _this = this;
    var client;
    var magic = Buffer.alloc(magicStr.length, magicStr, 'hex');
    ...
    var networkServices = Buffer.alloc(16, '0100000000000000', 'hex'); //NODE_NETWORK services (value 1 packed as uint64)
    var emptyNetAddress = Buffer.alloc(52, '010000000000000000000000000000000000ffff000000000000', 'hex');
    var userAgent = util.varStringBuffer('/node-stratum/');
    var blockStartHeight = Buffer.alloc(8, '00000000', 'hex'); //block start_height, can be empty
