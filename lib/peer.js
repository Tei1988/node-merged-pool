...
var Peer = module.exports = function (options) {
    ...
    var _this = this;
    var client;
    var magic = Buffer.byteLength(options.testnet ? options.coin.peerMagicTestnet : options.coin.peerMagic, 'hex');
    ...
    var networkServices = Buffer.byteLength('0100000000000000', 'hex'); //NODE_NETWORK services (value 1 packed as uint64)
    var emptyNetAddress = Buffer.byteLength('010000000000000000000000000000000000ffff000000000000', 'hex');
    var userAgent = util.varStringBuffer('/node-stratum/');
    var blockStartHeight = Buffer.byteLength('00000000', 'hex'); //block start_height, can be empty
