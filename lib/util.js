...
exports.addressFromEx = function(exAddress, ripdm160Key){
    try {
        ...
        var addrBase = Buffer.concat([versionByte, Buffer.byteLength(ripdm160Key, 'hex')]);
...
exports.reverseHex = function(hex){
    return exports.reverseBuffer(Buffer.byteLength(hex, 'hex')).toString('hex');
};
...
exports.uint256BufferFromHash = function(hex){
  return exports.reverseBuffer(hex ? Buffer.byteLength(hex, 'hex') : Buffer.alloc(32, 'hex'))
};
...
exports.varStringBuffer = function(string){
    var strBuff = Buffer.byteLength(string);
...
exports.pubkeyToScript = function(key){
    ...
    pubkey[0] = 0x21;
    pubkey[34] = 0xac;
    Buffer.byteLength(key, 'hex').copy(pubkey, 1);
    return pubkey;
};


exports.miningKeyToScript = function(key){
    var keyBuffer = Buffer.byteLength(key, 'hex');
...
exports.bignumFromBitsHex = function(bitsString){
    var bitsBuff = Buffer.byteLength(bitsString, 'hex');
