...
var JobManager = module.exports = function JobManager(options){
 ...
 //public members
    ...
    this.extraNoncePlaceholder = Buffer.alloc(16, 'f000000ff111111f', 'hex');
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        var extraNonce1Buffer = Buffer.alloc(extraNonce1.length, extraNonce1, 'hex');
        var extraNonce2Buffer = Buffer.alloc(extraNonce2.length, extraNonce2, 'hex');
