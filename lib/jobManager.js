...
var JobManager = module.exports = function JobManager(options){
 ...
 //public members
    ...
    this.extraNoncePlaceholder = Buffer.byteLength('f000000ff111111f', 'hex');
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        var extraNonce1Buffer = Buffer.byteLength(extraNonce1, 'hex');
        var extraNonce2Buffer = Buffer.byteLength(extraNonce2, 'hex');
